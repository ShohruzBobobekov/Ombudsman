...
namespace Ombudsman.DataLayer.Models
{
    ...
    public partial class EnumDocumentRealizerTypeTranslate
    {
        [Key]
        [Column("id")]
        ...
        [InverseProperty("EnumDocumentRealizerTypeTranslates")]
        public virtual EnumLanguage Language { get; set; } = null!;
        [ForeignKey("OwnerId")]
        [InverseProperty("EnumDocumentRealizerTypeTranslates")]
        public virtual EnumDocumentRealizerType Owner { get; set; } = null!;
    }
}
